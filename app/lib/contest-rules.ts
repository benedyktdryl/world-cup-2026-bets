...
export const contestRulesSummary = [
  ...
  `Submit predictions at least ${BETTING_CLOSE_HOURS} hours before kickoff.`,
  "Late joiners are welcome, but only matches you predicted in time count toward your score.",
